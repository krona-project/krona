...
#pragma warning disable CS0612
        public static readonly RegisterTransaction GoverningToken = new RegisterTransaction
        {
            ...
            Name = "[{\"lang\":\"en\",\"name\":\"Krona\"}]",
            Amount = Fixed8.FromDecimal(1500000),
            Precision = 8,
...
#pragma warning restore CS0612
        ...
        public static readonly Block GenesisBlock = new Block
        {
            ...
            Index = 0,
            ConsensusData = 2083236893, //Bitcoin Nonce
        ...
        private readonly KronaSystem system;
        ...
        public Fixed8 GetBlockReward()
        {
            uint halvings = Blockchain.Singleton.Height / 6307200;
            // Force block reward to zero when right shift is undefined.
            if (halvings >= 64)
                return Fixed8.FromDecimal(0);

            // Subsidy is 3 COINS per 10 minutes
            decimal nSubsidy = (3 >> (int)halvings) / ((decimal)10 * (decimal)60 / (decimal)Blockchain.SecondsPerBlock);
            // Subsidy is cut in half every 6,307,200 blocks which will occur approximately every 2 years.
            return Fixed8.FromDecimal(nSubsidy);
        }
        ...
        private void OnFillMemoryPool(IEnumerable<Transaction> transactions)
        {
            ...
            {
                if (tx.Type == TransactionType.BlockReward)
                    continue;
        ...
        private RelayResultReason OnNewTransaction(Transaction transaction)
        {
            try
            {
                if (transaction.Type == TransactionType.BlockReward)
                    return RelayResultReason.Invalid;
