...
namespace Krona
{
    ...
    {
        public static KronaSystem KronaSystem;
        ...
        public static void Main()
        {
            ...
            try
            {
                xdoc = XDocument.Load("https://raw.githubusercontent.com/krona-project/krona-gui/master/update.xml");
            }
            catch { }
            if (xdoc != null)
            {
            ...
            using (KronaSystem = new KronaSystem(store))
            {
