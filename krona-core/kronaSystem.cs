...
namespace Krona
{
    public class KronaSystem : IDisposable
    {
        public ActorSystem ActorSystem { get; } = ActorSystem.Create(nameof(KronaSystem),
        ...
        public KronaSystem(Store store)
        {
            this.store = store;
