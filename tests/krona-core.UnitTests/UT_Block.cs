...
namespace Krona.UnitTests
{
    ...
    public class UT_Block
    {
        ...
        private P2PTransaction getP2PTransaction(bool inputVal, decimal outputVal, UInt256 assetId)
        {
        ...
        [TestMethod]
        public void CalculateNetFee_Ignores_BlockRewards()
        {
            UInt256 val256 = UInt256.Zero;
            UInt256 merkRootVal;
            UInt160 val160;
        ...
        public void CalculateNetFee_Out()
        {
            ...
            uut.Transactions = new Transaction[1] {
                getP2PTransaction(false, 100, Blockchain.GoverningToken.Hash)
            };
        ...
        public void ToJson()
        {
            ...
            txObj[0]["type"].AsString().Should().Be("BlockReward");
