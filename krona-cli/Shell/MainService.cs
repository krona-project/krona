...
using ECCurve = Krona.Cryptography.ECC.ECCurve;
using ECPoint = Krona.Cryptography.ECC.ECPoint;
...
namespace Krona.Shell
{
    internal class MainService : ConsoleServiceBase
    {
        ...
        protected override string Prompt => "krona";
        public override string ServiceName => "LITTUS-CLI";
        ...
        private bool OnCreateWalletCommand(string[] args)
        {
            ...
            switch (Path.GetExtension(path))
            {
                case ".db3":
                    ...
                    break;
                default:
                    Console.WriteLine("Wallet files in that format are not supported, please use .db3 file extension.");
                    break;
            }
            return true;
        }
        ...
        private bool OnListAssetCommand(string[] args)
        {
            ...
            {
                Console.WriteLine($"  balance:{item.Balance} KRN");
        ...
        private bool OnInstallCommand(string[] args)
        {
            ...
            Console.WriteLine($"Install successful, please restart krona-cli.");
            return true;
        }
        ...
        private bool OnUnInstallCommand(string[] args)
        {
            ...
            Console.WriteLine($"Uninstall successful, please restart krona-cli.");
            return true;
        }
