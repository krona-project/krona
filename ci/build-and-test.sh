#!/bin/bash
#
# This script builds krona-cli with dotnet 2.0, and runs the tests.
#
CONTAINER_NAME="krona-cli-ci"
...
# Build the Docker image (includes building the current krona-cli code)
